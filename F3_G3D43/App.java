...
public class App {
    ...
    private static void novoAtivo() throws SQLException {
        ...
        System.out.println("Apenas sao aceites empresas ja presentes no sistema");
    ...
    private static void substituirElem() throws SQLException {
        System.out.println("Pessoa a ser substituida");
        List<String> nomePessoas = queries.getNomePessoas();
        printList(nomePessoas);
    ...
    private static void optionsMenuDisplay() {
        System.out.println();
        System.out.println("Gestao de manutencao de activos fisicos");
        System.out.println("1. Novo Ativo (a)");
        System.out.println("2. Substituir um elemento de equipa (b)");
        System.out.println("3. Colocar Ativo Fora de Servico (c)");
        System.out.println("4. Custo Total Ativo (d)");
        System.out.println("5. Pessoas que estao a realizar a intervencao de determinado ativo ou que gerem esse ativo (2d)");
        System.out.println("6. Ativos geridos ou intervencionados por determinada pessoa (2e)");
        System.out.println("7. Responsaveis de equipa que sao (ou foram) gestores de pelo menos um ativo (3c)");
        System.out.println("8. Intervencoes programadas para daqui a um mes (3d)");
